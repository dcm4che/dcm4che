 ...
 *
 * ***** END LICENSE BLOCK ***** */
package org.dcm4che.conf.ldap.imageio;
...
public class LdapImageWriterConfiguration extends LdapDicomConfigurationExtension {
    ...
    private Attributes storeTo(String tsuid, ImageWriterParam param, Attributes attrs) {
        ...
        LdapUtils.storeNotNull(attrs, "dcmPhotometricInterpretation", param.photometricInterpretation);
    ...
    private List<ModificationItem> storeDiffs(ImageWriterParam prevParam,
        ...
        LdapUtils.storeDiff(mods, "dcmPhotometricInterpretation",
                prevParam.photometricInterpretation, param.photometricInterpretation);
