...
set MAIN_JAR=dcm4che-tool-dcm2dcm-3.3.3-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-3.3.3-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-3.3.3-SNAPSHOT.jar
...
if not "%IMAGE_WRITER_FACTORY%" == "" ^
 set JAVA_OPTS=%JAVA_OPTS% "-Dorg.dcm4che.imageio.codec.ImageWriterFactory=%IMAGE_WRITER_FACTORY%
