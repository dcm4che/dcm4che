    ...
    Verification SOP Class. DICOM files specified on the command  line are
    scanned and for each different Study a MPPS N-CREATE and a MPPS N-SET
    message referencing the SOP Instances in the scanned files is sent to a
    Service Class Provider (SCP) of the MPPS SOP Class. If no DICOM file is
    specified, it sends a DICOM C-ECHO message and waits for a response.
    -
    Options:
     ...
     -h,--help                                display this help and exit
        ...
        --ppsuid <uid>                        specify Affected SOP Instance
                                              ...
                                              '.2',... . If not specified, no
                                              SOP Instance UID will be
                                              supplied in the MPPS N-CREATE RQ
                                              so the MPPS SCP has to assign a
                                              value.
