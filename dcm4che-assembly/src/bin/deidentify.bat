...
set MAIN_JAR=dcm4che-tool-deidentify-${project.version}.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-dcmr-${project.version}.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-deident-${project.version}.jar
