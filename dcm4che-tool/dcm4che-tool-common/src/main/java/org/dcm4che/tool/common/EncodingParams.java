...
public class EncodingParams {
    ...
    public final void setUndefSequenceLength(boolean undefSeqLength) {
    ...
    public final void setUndefEmptySequenceLength(boolean undefEmptySeqLength) {
    ...
    public final void setUndefItemLength(boolean undefItemLength) {
    ...
    public final void setUndefEmptyItemLength(boolean undefEmptyItemLength) {
