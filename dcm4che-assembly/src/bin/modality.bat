...
set MAIN_JAR=dcm4che-tool-ihe-modality-${project.version}.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mppsscu-${project.version}.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-storescu-${project.version}.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-stgcmtscu-${project.version}.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mkkos-${project.version}.jar
