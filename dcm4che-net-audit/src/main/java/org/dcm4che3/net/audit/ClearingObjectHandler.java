...
/**
 * Nulls the payload of the ring buffer event so the payload (e.g. audit message) can be GCed.
 *
 * @author Alexander Hoermandinger <alexander.hoermandinger@agfa.com>
 **/
public class ClearingObjectHandler implements EventHandler<AuditMessageEvent> {
