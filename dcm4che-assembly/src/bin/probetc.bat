...
set MAIN_JAR=dcm4che-tool-probetc-3.3.4-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-api-3.3.4-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-ldap-3.3.4-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-prefs-3.3.4-SNAPSHOT.jar
