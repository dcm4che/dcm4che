...
set MAIN_JAR=dcm4che-tool-dcm2dcm-3.3.2-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-3.3.2-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-3.3.2-SNAPSHOT.jar
