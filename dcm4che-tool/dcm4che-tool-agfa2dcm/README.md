...
Options:
 ...
 -p <pattern>   file path of stored objects, '{ggggeeee}' will be replaced
                ...
                store received objects using the SOP Instance UID
                ...
                Instance UID (0020,000E). At default, received objects are
                stored to the storage directory with the SOP Instance UID
                (0008,0018) as file name without extension.
