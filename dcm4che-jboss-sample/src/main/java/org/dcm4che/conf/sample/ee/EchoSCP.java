...
package org.dcm4che.conf.sample.ee;
...
public class EchoSCP extends DeviceService implements EchoSCPMBean {
    ...
    public static final String DEVICE_NAME = "org.dcm4che.conf.sample.deviceName";
    public static final String JMX_NAME = "org.dcm4che.conf.sample.jmxName";
    public static final String KS_TYPE = "org.dcm4che.conf.sample.keyStoreType";
    public static final String KS_URL = "org.dcm4che.conf.sample.keyStoreURL";
    public static final String KS_PASSWORD = "org.dcm4che.conf.sample.storePassword";
    public static final String KEY_PASSWORD = "org.dcm4che.conf.sample.keyPassword";
