...
Options:
 -C <name=value>               specify additional compression parameter
    --decoding-speed <speed>   decoding speed (0-4) of JPEG XL compression
    --effort <effort>          compression effort level (1-9) of JPEG XL
                               compression
 ...
 -f,--retain-fmi               retain File Meta Information from source
                               files if available. At default the File
                               Meta Information is replaced by one
                               referencing dcm4che-3.x
 ...
 -h,--help                     display this help and exit
    ...
    --jxll                     compress JPEG XL Lossless; equivalent to -t
                               1.2.840.10008.1.2.4.110
    --jxly                     compress JPEG XL Lossy; equivalent to -t
