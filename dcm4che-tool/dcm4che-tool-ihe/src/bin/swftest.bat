...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mppsscu-3.0.0-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-storescu-3.0.0-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-stgcmtscu-3.0.0-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mkkos-3.0.0-SNAPSHOT.jar
