...
class RetrieveTaskImpl extends BasicRetrieveTask {
    ...
    public RetrieveTaskImpl(Association as, PresentationContext pc, Attributes rq,
            Attributes keys, DicomDirReader ddr) throws DicomServiceException {
        super(as, pc, rq);
        try {
            calculateMatches(ddr,
                    keys.getStrings(Tag.PatientID),
    ...
    private void calculateMatches(DicomDirReader ddr, String[] patIDs, String[] studyIUIDs,
            String[] seriesIUIDs, String[] sopIUIDs) throws IOException {
            ...
            while (studyRec != null) {
                ...
                while (seriesRec != null) {
                    ...
                    while (instRec != null) {
                        ...
                        insts.add(new InstanceLocator(cuid, iuid, tsuid, uri));
