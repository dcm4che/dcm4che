...
set MAIN_JAR=dcm4che-tool-storescu-3.3.5-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-3.3.5-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-3.3.5-SNAPSHOT.jar
