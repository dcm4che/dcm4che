...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="uidsEx">
    ...
    <uid value="1.2.40.0.13.1.5.1.4.1.1.104.2" keyword="PrivateDcm4cheEncapsulatedVCFBzip2Storage" type="SOPClass">Private Dcm4che Encapsulated VCF Bzip2 Storage</uid>
    <uid value="1.2.40.0.13.1.5.1.4.1.1.104.3" keyword="PrivateDcm4cheEncapsulatedGeneralBzip2Storage" type="SOPClass">Private Dcm4che Encapsulated General Bzip2 Storage</uid>
