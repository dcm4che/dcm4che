...
set MAIN_JAR=dcm4che-tool-ihe-modality-3.2.0.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mppsscu-3.2.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-storescu-3.2.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-stgcmtscu-3.2.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mkkos-3.2.0.jar
